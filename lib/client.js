...
Client.prototype._defineMethod = function (method, location) {
	...
	return function (args, callback, options, extraHeaders) {
		...
		self._invoke(
			...
			args,
			location,
			function (error, result, rawResponse, soapHeader, rawRequest) {
...
Client.prototype._invoke = function (
	...
	xml =
		...
		(self.soapHeaders || self.security
			? "<" +
			  ...
			  (self.security && !self.security.postProcess
					? self.security.toXML()
					: "") +
			  "</" +
			  envelopeKey +
	...
	if (
		location ==
		"http://bambatest.itravelsoftware.com/itravel/API/WebService/iTravelAPI_3_0.asmx"
	) {
		location =
			"https://bambatest.itravelsoftware.com/itravel/API/WebService/iTravelAPI_3_0.asmx";
	}

	if (
		location ==
		"http://bamba.itravelsoftware.com/itravel/API/WebService/iTravelAPI_3_0.asmx"
	) {
		location =
			"https://bamba.itravelsoftware.com/itravel/API/WebService/iTravelAPI_3_0.asmx";
	}
	...
	req = self.httpClient.request(
		...
		function (err, response, body) {
			...
			if (err) {
				...
				console.log(" ");
				console.log("Aqui ya recibio la respuesta de la api de lemax");
				console.log(" ");
				return parseSync(body, response);
			}
		},
